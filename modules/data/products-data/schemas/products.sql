-- =====================================================
-- Products Data Module - Complete Schema
-- =====================================================
-- Description: Complete products table schema with RLS, indexes and triggers
-- Version: 1.0.0
-- Created: 2025-12-08
-- =====================================================
...
-- Index on seller_id for seller's product listings
...
-- GIN index on images for JSONB queries
...
-- Policy: Only product owner can update their products
...
-- Policy: Only product owner can delete their products
